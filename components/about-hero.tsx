    ...
    <section className="relative pt-32 pb-20 bg-gray-900 text-white overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 text-center">
        <h1 className="text-5xl md:text-6xl font-bold mb-6 drop-shadow-2xl text-white text-shadow-white">
          {t("about.title")} <span className="text-[#fĩff66] text-shadow-yellow">{t("about.subtitle")}</span>
        </h1>
        <p className="text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed drop-shadow-lg text-white text-shadow-white">{t("about.description")}</p>
      </div>
    </section>
  )
}
